import{q as h,r as o,s as e,t as p,v as i,w as n,x as m,y as d,z as F,A as f,C as E,D as v,E as M}from"./index.caf06f59.js";import{f as u,g as B,i as I,j as V}from"./index.2927060c.js";import{an as c,cc as x,cd as H}from"./index.c2ccb594.js";import{I as k}from"./Layout.8906b8ff.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function D(a){return c({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>`},a)}function A(a){return c({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#909090"
  ...
  ></path>F`},a)}const L={"dmg,ipa,plist,tipa":n,"exe,msi":m,"zip,gz,rar,7z,tar,jar,xz":d,apk:k,db:u,md:F,epub:B,iso:I,m3u8:i,"doc,docx":f,"xls,xlsx":E,"ppt,pptx":v,pdf:M,psd:D,ai:A,url:V},Z=(a,t)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(t.toLowerCase()))return r}switch(a){case l.FOLDER:return H;case l.VIDEO:return i;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},S=a=>Z(a.type,x(a.name));export{l as O,S as g};
