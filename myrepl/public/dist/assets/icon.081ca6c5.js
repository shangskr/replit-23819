import{r as h,s as o,t as e,v as p,w as c,x as n,y as m,z as d,A as F,C as f,D as E,E as v,F as M}from"./index.c693502e.js";import{g as u,h as B,j as I,k as V}from"./index.6261c110.js";import{an as i,cc as k,cd as x}from"./index.c40f852e.js";import{I as H}from"./Layout.bc7bffba.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function D(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>`},a)}function A(a){return i({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#909090"
  ...
  ></path>F`},a)}const L={"dmg,ipa,plist,tipa":n,"exe,msi":m,"zip,gz,rar,7z,tar,jar,xz":d,apk:H,db:u,md:F,epub:B,iso:I,m3u8:c,"doc,docx":f,"xls,xlsx":E,"ppt,pptx":v,pdf:M,psd:D,ai:A,url:V},Z=(a,t)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(t.toLowerCase()))return r}switch(a){case l.FOLDER:return x;case l.VIDEO:return c;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},S=a=>Z(a.type,k(a.name));export{l as O,S as g};
