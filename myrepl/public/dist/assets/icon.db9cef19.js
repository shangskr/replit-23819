import{q as h,r as o,s as e,t as p,v as i,w as n,x as f,y as m,z as d,A as F,C as v,D as E,E as M}from"./index.e7b386d3.js";import{f as u,g as H,i as B,j as I}from"./index.e391513c.js";import{an as c,cc as V,cd as x}from"./index.a6b3a216.js";import{I as k}from"./Layout.3a51487c.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function A(a){return c({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function S(a){return c({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const D={"dmg,ipa,plist,tipa":n,"exe,msi":f,"zip,gz,rar,7z,tar,jar,xz":m,apk:k,db:u,md:d,epub:H,iso:B,m3u8:i,"doc,docx":F,"xls,xlsx":v,"ppt,pptx":E,pdf:M,psd:A,ai:z,url:I},L=(a,t)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(D))if(s.split(",").includes(t.toLowerCase()))return r}switch(a){case l.FOLDER:return x;case l.VIDEO:return i;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},P=a=>L(a.type,V(a.name));export{S as A,l as O,P as g};
